...
class ClassTeacher { // Renamed the class to a more concise name
   ...
   ClassTeacher() { //Default Constructor, that means it has no parameter
   }
    ...
    public static void main(String[] args) {
        ...
        ClassTeacher teacher3 = new ClassTeacher(); // Calling the default constructor
        teacher3.display();

        //Note: If we even dont create default constructor, java will create it automatically
        // and teacher3 will be initialized with default values.
    }
}
